 ...
 *
 * No lleva carátula (al contrario que [com.untarlamanteca.ultimusic.ui.songs.SongsAdapter]) porque
...
class DetailSongsAdapter(
    ...
    override fun onBindViewHolder(holder: TrackViewHolder, position: Int) {
        holder.bind(tracks[position], position, onSongClick, onAddToQueue, onEditMetadata)
    }
